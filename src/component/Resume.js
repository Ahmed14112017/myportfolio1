    ...
    <div className='w-full flex flex-col gap-6 items-center justify-center py-20 px-10 border-b-[1px] border-b-black'>
      ...
      <ul className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 '>
        ...
        <div className="mt-6 lgl:mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          ...
          <div className='p-5 bg-black bg-opacity-20 hover:bg-opacity:40 duration-400 rounded-lg w-[500px] shadow-shadowOne text-lightText flex flex-col gap-5'>
            <div className='w-full flex flex-row justify-between items-center'>
              <div className='p-3'>
              <h3 className='text-xl'>BSc in Computer Science</h3>
